...
import (
	...
	"github.com/otterize/network-mapper/src/shared/criclient/internal"
	"github.com/otterize/network-mapper/src/shared/criclient/util"
)
...
func NewRemoteRuntimeService(endpoint string, connectionTimeout time.Duration, logger *klog.Logger) (internalapi.RuntimeService, error) {
	...
	conn, err := grpc.Dial(addr, dialOpts...) // nolint:staticcheck
	if err != nil {
