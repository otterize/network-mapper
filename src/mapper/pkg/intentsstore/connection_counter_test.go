			...
			SetupInput: []CounterInput{
				{
					...
					SourcePorts: []*int64{lo.ToPtr(int64(1))},
				},
				{
					Intent:      model.Intent{ResolutionData: lo.ToPtr("addSocketScanServiceIntent")},
					SourcePorts: []*int64{lo.ToPtr(int64(2))},
				},
			},
			TestIntent: CounterInput{
				Intent:      model.Intent{ResolutionData: lo.ToPtr("addSocketScanServiceIntent")},
				SourcePorts: []*int64{lo.ToPtr(int64(3))},
			},
	...
	testCases := []DiffTestCase{
		...
		},
		{
			...
			PrevSetupInput: []CounterInput{
				{
					Intent:      model.Intent{ResolutionData: lo.ToPtr("handleInternalTrafficTCPResult")},
					SourcePorts: []*int64{lo.ToPtr(int64(10))},
				},
			},
			CurrentSetupInput: []CounterInput{
				{
		...
		},
		{
			...
			PrevSetupInput: []CounterInput{
				{
					Intent:      model.Intent{ResolutionData: lo.ToPtr("handleInternalTrafficTCPResult")},
					SourcePorts: []*int64{lo.ToPtr(int64(1)), lo.ToPtr(int64(10)), lo.ToPtr(int64(100))},
				},
			},
			CurrentSetupInput: []CounterInput{
				{
					Intent:      model.Intent{ResolutionData: lo.ToPtr("handleInternalTrafficTCPResult")},
					SourcePorts: []*int64{lo.ToPtr(int64(100)), lo.ToPtr(int64(200))},
				},
			},
			ExpectedConnectionsCount: cloudclient.ConnectionsCount{
				Current: lo.ToPtr(2),
