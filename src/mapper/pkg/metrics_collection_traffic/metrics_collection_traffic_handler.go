...
func (r *MetricsCollectionTrafficHandler) HandleAllPods(ctx context.Context, req ctrl.Request) error {
...
func (r *MetricsCollectionTrafficHandler) HandleAllServices(ctx context.Context, req ctrl.Request) error {
