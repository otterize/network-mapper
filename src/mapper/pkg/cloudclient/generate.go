...
//go:generate sh -c "if [ -z $CI ]; then go run github.com/suessflorian/gqlfetch/gqlfetch --endpoint http://app.staging.otterize.com/api/graphql/v1beta > schema.graphql; fi"
